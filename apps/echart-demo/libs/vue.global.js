...
`], ...formatTraceEntry(entry));
  ...
  function devtoolsInitApp(app, version) {
    emit$1("apps:init" /* APP_INIT */, app, version, {
      Fragment,
      Text,
      Comment,
      Static
  ...
  function devtoolsUnmountApp(app) {
    emit$1("apps:unmount" /* APP_UNMOUNT */, app);
  }
        ...
        mixin(mixin) {
          {
            if (!context.mixins.includes(mixin)) {
              ...
              warn$1(
                "Mixin has already been applied to target apps" + (mixin.name ? `: ${mixin.name}` : "")
              );
            }
          }
          return app;
  ...
  const createApp = (...args) => {
    ...
    app.mount = (containerOrSelector) => {
      ...
      if (container instanceof Element) {
        ...
        container.setAttribute("data-v-apps", "");
      }
      return proxy;
    };
    return app;
